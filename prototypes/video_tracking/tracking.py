...
def motion_detection(show_video=False):
    """
    Uses the camera to move the turret. OpenCV ust be configured to use this.
    :return:
    """
    VideoUtils.find_motion(show_video=show_video)
...
class VideoUtils(object):
    ...
    @staticmethod
    def find_motion(camera_port=0, show_video=False):
...
if __name__ == "__main__":
    motion_detection(show_video=True)
